...
import { CustomContainerTable, CustomHeaderTable, CustomItemTable } from "../SimpleTable";

function TableCostDetails({total, iva, totalWhitIva}) {
    return (
        <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', height: '80px', justifyContent: 'space-between', width: '100%', gap:'10px', position:'absolute', bottom:'10px' }}>
