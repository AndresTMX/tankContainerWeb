...
function TableProforma({arrayConcepts, tanque}) {
...
export function RowsProformaSencilla({ cantidad, concepto, pu, importe, description , tanque}) {
    return (
        <CustomHeaderTable widthHeader={'100%'} backgroundColor={'white'}>
            <CustomItemTable text={cantidad} widthColumn={'10%'} borderColor={'gray'} />
            <CustomItemTable text={concepto} widthColumn={'65%'} borderColor={'gray'} heightItem={'60px'}>
