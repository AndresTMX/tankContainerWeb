...
function useEditManiobra() {
    ...
    const editManiobrasTypeEmpty = async (typeRegister, updates, idRegister) => {
    ...
    const routerFetch = async ( typeChargue, typeRegister, oldDataTanks, newDataTanks, newDataPipes, updates, idRegister) => {

        console.log(typeChargue)
        ...
        const routes = {
            ...
            vacio: async () => await editManiobrasTypeEmpty(typeRegister, updates, idRegister)
        }
    
        if (routes[typeChargue]) {
            try {
                await routes[typeChargue]();
                console.log(`Acción para ${typeRegister} completada exitosamente.`);
            } catch (error) {
                console.error(`Error al ejecutar la acción para ${typeRegister}:`, error.message);
            }
        } else {
            console.error(`No se encontró una acción válida para ${typeRegister}.`);
        }
    };
